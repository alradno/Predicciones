...
from predicciones.multi_market import (
    ACTIVE_FAMILIES,
...
class MultiMarketTests(unittest.TestCase):
    ...
    def test_multi_market_lane_cycle_script_has_safe_dry_run_mode(self) -> None:
        ...
        self.assertIn("capture-market-raw", content)
        self.assertIn("build-market-lane-predictions", content)
        self.assertIn("run-market-lane", content)
